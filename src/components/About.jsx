    ...
    <>
      <section className="flex flex-col md:flex-row bg-gray-900 items-center justify-between gap-10 px-6 md:px-20 py-12 pt-16">
        ...
        <div className="flex items-center justify-center w-full md:w-1/2">
          <div ref={imgParentRef} className="">
            <motion.div
        ...
        <div className="flex flex-col items-start justify-center text-left w-full md:w-1/2">
          ...
          <p className="  text-indigo-400 font-ubntu  leading-relaxed mb-6 ">
            ...
            Developing, And Deploying Robust, Scalable Applications.
            Proficiently Builds And Optimizes Microservices And Web Services,
            Specializing In Restful API Implementations. Expertly Crafts Dynamic
            User Interfaces Using HTML, CSS, Javascript, And Modern Frameworks
            Like Bootstrap, Tailwind, And Material UI.
          </p>
          <button
            onClick={() => {
      ...
      <section className="flex min-h-screen bg-gray-900 flex-col md:flex-row items-center justify-between gap-10 px-6 md:px-20 py-12 ">
        <div
          ref={sectionRef}
          className="min-h-screen w-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl  text-gray-800 flex flex-col items-center px-4 sm:px-6 lg:px-12 py-16 "
        >
          {/* Heading */}
          <motion.h1
          ...
          <div className="fade-up w-full max-w-6xl mb-16 text-center px-2 sm:px-6">
            <h2 className="text-2xl font-mery sm:text-3xl font-semibold mb-6 text-black">
              Skills
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
              {visibleSkills.map((skill, i) => (
                <motion.div
                  ...
                  className="p-4 sm:p-5 tracking-wider font-ubntu rounded-2xl shadow-lg bg-white text-center font-medium text-base sm:text-lg hover:shadow-2xl transition break-words overflow-hidden"
                >
                  {skill}
                </motion.div>
              ))}
          ...
          {/* Tools */}
          <div className="fade-up w-full max-w-6xl mb-16 text-center px-2 sm:px-6">
            <h2 className="text-2xl font-mery sm:text-3xl font-semibold mb-6 text-red-800">
              Tools
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
              {visibleTools.map((tool, i) => (
                <motion.div
                  ...
                  // transition={{ duration: 0.8, delay: i * 0.05 }}
                  whileHover={{ scale: 1.1, rotate: -2 }}
                  className="p-4 sm:p-5 font-ubntu tracking-wider rounded-2xl shadow-lg bg-white text-center font-medium text-base sm:text-lg hover:shadow-2xl transition break-words overflow-hidden"
                >
                  {tool}
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:justify-center md:gap-16 gap-6 text-base sm:text-lg flex-wrap px-4">
              <div className="flex items-center gap-2 justify-center break-words text-sm sm:text-base">
              ...
              <a
                ...
                className="flex items-center gap-2 justify-center hover:text-green-600 transition break-words text-sm sm:text-base"
              >
              ...
              <a
                href="mailto:ranarajeevsingh1540@gmail.com"
                className="flex items-center gap-2 justify-center hover:text-red-600 transition break-all text-sm sm:text-base"
              >
            ...
            >
              ...
              >
                <FaGithub
                  size={28}
                  className="sm:size-32 hover:text-gray-700 transition"
                />
              </motion.a>
              <motion.a
              ...
              >
                <FaLinkedin
                  size={28}
                  className="sm:size-32 text-blue-600 hover:text-blue-800 transition"
                />
              </motion.a>
            </div>
          </motion.div>
